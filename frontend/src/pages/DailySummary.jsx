...
// import { fetchDailySummary, deleteTask, updateTask } from '@/store/slices/taskSlice';
...
//   const [editTask, setEditTask] = useState(null); // State to manage task being edited
...
//         )}
//         <Button className="ml-auto" onClick={() => setModalOpen(true)}>Add a Task</Button>
//       </div>
...
//                     {canDelete && (
//                       <Button className="hover:bg-green-700 hover:text-white" variant="outline" onClick={() => openEditModal(task)}>
